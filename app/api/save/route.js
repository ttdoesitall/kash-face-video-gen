...
export async function POST(request) {
    try {
          ...
          return Response.json({
                  ...
                  mode: 'partial',
                  warning:
                    'Saved title, script, and movement prompt. Avatar prompt, gender, and image were not saved because the videos table is missing avatar_prompt, gender, and image_base64 columns.',
                });
        } catch (error) {
